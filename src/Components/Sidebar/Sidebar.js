  ...
  return (
    <>
      ...
      <div className="mobile-toggle" onClick={handleMobileMenuToggle}>
        ...
        ><svg fill="#000000" width="20px" height="20px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" ><title>menu</title><path d="M64 96L448 96 448 144 64 144 64 96ZM64 232L448 232 448 280 64 280 64 232ZM64 368L448 368 448 416 64 416 64 368Z" /></svg></span>
      </div>
    </>
  );
};
